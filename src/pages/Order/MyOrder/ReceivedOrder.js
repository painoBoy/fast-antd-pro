...
export default class ReceivedOrder extends React.PureComponent{
  ...
  columns = [
    ...
    },
    {
      title: '操作',
      render: (text, record) => (
        <a onClick={() => this.handleUpdateModalVisible(true, record)}>确认</a>
  ...
  handleExportExcel = () => {
    ...
    const _headers = [{ k: 'id', v: '订单号' },{k:'strReceiverId',v:'采购医院'}, { k: 'strReceiver', v: '院方采购人' },
            { k: 'lx', v: '部门' }, { k: 'strreceivertel', v: '联系电话' },{k:'datereceive',v:'发货时间'},{k:'status',v:'状态'}]
