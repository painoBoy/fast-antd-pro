...
export default class CompleteOrder extends React.PureComponent{
  ...
  handleExportExcel = () => {
    ...
    const _headers = [{ k: 'id', v: '订单号' }, { k: 'strReceiverId', v: '院方采购人' },
            { k: 'lx', v: '部门' }, { k: 'strreceivertel', v: '联系人电话' },{k:'datereceive',v:'收货时间'},{k:'status',v:'状态'}]
