export default {
  ...
  'app.login.get-verification-code': '验证码',
  'app.login.message-invalid-credentials': '账户或密码错误（admin/aaaaaa）',
  'app.login.message-invalid-verification-code': '验证码错误',
  'app.login.tab-login-credentials': '账户密码登录',
  'app.login.tab-login-mobile': '手机号登录',
  'app.login.remember-me': '自动登录',
  'app.login.forgot-password': '忘记密码',
  'app.forgot.recover-password': '找回密码',
  'app.login.sign-in-with': '其他登录方式',
  'app.login.signup': '注册账户',
  'app.login.activation': '激活账户',
  'app.login.login': '登录',
  'app.register.register': '激活账户',
  ...
  'validation.captpic.required': '请输入验证码！',
  'validation.activeCode.required': '请输入激活码！',
